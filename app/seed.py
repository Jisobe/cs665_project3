...
def generate_patient_num(patient_id):
    return f"PAT-{patient_id:03d}"
...
def _seed_visits():
    records=[
        Visit(visit_id=1, visit_num="VST-001", patient_id=1, national_provider_identifier=_PRV_TO_NPI["PRV-001"], visit_date=datetime(2024, 1, 15, 9,  0),  visit_reason="Annual physical"),
        Visit(visit_id=2, visit_num="VST-002", patient_id=2, national_provider_identifier=_PRV_TO_NPI["PRV-002"], visit_date=datetime(2024, 2, 10, 10, 30), visit_reason="Chest tightness"),
        Visit(visit_id=3, visit_num="VST-003", patient_id=3, national_provider_identifier=_PRV_TO_NPI["PRV-001"], visit_date=datetime(2024, 3,  5,  8, 45), visit_reason="Persistent cough"),
        Visit(visit_id=4, visit_num="VST-004", patient_id=4, national_provider_identifier=_PRV_TO_NPI["PRV-003"], visit_date=datetime(2024, 3, 20, 14,  0), visit_reason="Palpitations"),
        Visit(visit_id=5, visit_num="VST-005", patient_id=5, national_provider_identifier=_PRV_TO_NPI["PRV-005"], visit_date=datetime(2024, 4,  8, 11, 15), visit_reason="High blood sugar symptoms"),
        Visit(visit_id=6, visit_num="VST-006", patient_id=1, national_provider_identifier=_PRV_TO_NPI["PRV-004"], visit_date=datetime(2024, 5, 14, 13,  0), visit_reason="Knee pain after running"),
        Visit(visit_id=7, visit_num="VST-007", patient_id=2, national_provider_identifier=_PRV_TO_NPI["PRV-002"], visit_date=datetime(2024, 6,  1,  9, 30), visit_reason="Blood pressure check"),
    ]
    _bulk_insert(records, "Visits")

def _seed_vitals():
    records=[
        Vitals(vitals_id=1, vitals_num="VTL-001", visit_id=1, height=65, weight=158.0, systolic=118, diastolic=76, temperature=98.4, heart_rate=68, pain_level=2, recorded_by="Frank Daniels"),
        Vitals(vitals_id=2, vitals_num="VTL-002", visit_id=2, height=71, weight=195.0, systolic=142, diastolic=90, temperature=98.6, heart_rate=92, pain_level=6, recorded_by="Grace Williams"),
        Vitals(vitals_id=3, vitals_num="VTL-003", visit_id=3, height=62, weight=121.0, systolic=110, diastolic=70, temperature=99.1, heart_rate=74, pain_level=3, recorded_by="Frank Daniels"),
        Vitals(vitals_id=4, vitals_num="VTL-004", visit_id=4, height=68, weight=176.0, systolic=130, diastolic=84, temperature=98.2, heart_rate=88, pain_level=4, recorded_by="Isabella Potter"),
        Vitals(vitals_id=5, vitals_num="VTL-005", visit_id=5, height=63, weight=209.0, systolic=138, diastolic=88, temperature=98.8, heart_rate=80, pain_level=5, recorded_by="Jane Doe"),
        Vitals(vitals_id=6, vitals_num="VTL-006", visit_id=6, height=72, weight=200.0, systolic=122, diastolic=78, temperature=97.9, heart_rate=72, pain_level=7, recorded_by="Henry White"),
        Vitals(vitals_id=7, vitals_num="VTL-007", visit_id=7, height=65, weight=163.0, systolic=148, diastolic=94, temperature=98.5, heart_rate=70, pain_level=3, recorded_by="Grace Williams"),
    ]
...
def _seed_diagnoses():
    ...
    rows=[
        (1, "DGN-001", 1, "Z00.00", "resolved"),
        (2, "DGN-002", 2, "R07.9", "active"),
        (3, "DGN-003", 3, "J06.9", "resolved"),
        (4, "DGN-004", 4, "R00.2", "active"),
        (5, "DGN-005", 5, "E11.9", "chronic"),
        (6, "DGN-006", 1, "M79.36", "active"),
        (7, "DGN-007", 2, "I10", "active"),
    ]
    records=[
        Diagnosis(
        ...
        for diagnosis_id, diagnosis_num, patient_id, icd_code, status in rows
    ]
